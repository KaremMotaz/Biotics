...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "invalidCredential": MessageLookupByLibrary.simpleMessage(
      "بيانات الاعتماد المدخلة غير صحيحة أو منتهية الصلاحية.",
    ),
    ...
    "requiresRecentLogin": MessageLookupByLibrary.simpleMessage(
      "هذا الإجراء يتطلب تسجيل دخول حديث. يرجى تسجيل الدخول مرة أخرى.",
    ),
    ...
    "unknownAuthError": MessageLookupByLibrary.simpleMessage(
      "حدث خطأ غير معروف أثناء المصادقة.",
    ),
    "unknownFirestoreError": MessageLookupByLibrary.simpleMessage(
      "هناك خطأ غير معلوم الرجاء المحاولة في وقت اخر.",
    ),
    ...
    "weakPassword": MessageLookupByLibrary.simpleMessage(
      "كلمة المرور ضعيفة جدًا. جرب كلمة مرور أقوى.",
    ),
